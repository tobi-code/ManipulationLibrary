...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "filter_cython_new",
        "sources": [
            "filter_cython_new.pyx"
        ]
    },
    "module_name": "filter_cython_new"
}
END: Cython Metadata */
...
#define __PYX_HAVE__filter_cython_new
#define __PYX_HAVE_API__filter_cython_new
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'filter_cython_new' */
...
static double __pyx_f_17filter_cython_new_distance_cython(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_17filter_cython_new_region_filter_cython(__Pyx_memviewslice, __Pyx_memviewslice, int, __Pyx_memviewslice, __Pyx_memviewslice, double, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "filter_cython_new"
extern int __pyx_module_is_main_filter_cython_new;
int __pyx_module_is_main_filter_cython_new = 0;

/* Implementation of 'filter_cython_new' */
...
static const char __pyx_k_hand_cloud[] = "hand_cloud";
static const char __pyx_k_obj_center[] = "obj_center";
static const char __pyx_k_pyx_result[] = "__pyx_result";
static const char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_hand_center[] = "hand_center";
...
static const char __pyx_k_median_distance[] = "median_distance";
...
static PyObject *__pyx_n_s_hand_center;
static PyObject *__pyx_n_s_hand_cloud;
...
static PyObject *__pyx_n_s_median_distance;
...
static PyObject *__pyx_n_s_obj_center;
...
static PyObject *__pyx_pf_17filter_cython_new_distance_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_p1, __Pyx_memviewslice __pyx_v_p2); /* proto */
static PyObject *__pyx_pf_17filter_cython_new_2region_filter_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_center, __Pyx_memviewslice __pyx_v_pcd, int __pyx_v_hand_cloud, __Pyx_memviewslice __pyx_v_hand_center, __Pyx_memviewslice __pyx_v_obj_center, double __pyx_v_median_distance); /* proto */
...
static PyObject *__pyx_pw_17filter_cython_new_1distance_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_17filter_cython_new_distance_cython(__Pyx_memviewslice __pyx_v_p1, __Pyx_memviewslice __pyx_v_p2, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_r;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("distance_cython", 0);

  /* "filter_cython_new.pyx":7
 * 
 * cpdef double distance_cython(double[:] p1, double[:] p2):
 *     return sqrt((p1[0]-p2[0])**2 + (p1[1]-p2[1])**2 + (p1[2]-p2[2])**2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_p2.shape[0];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_p2.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 7, __pyx_L1_error)
  }
  ...
  } else if (unlikely(__pyx_t_4 >= __pyx_v_p1.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 7, __pyx_L1_error)
  }
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_v_p2.shape[0];
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_5 >= __pyx_v_p2.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 7, __pyx_L1_error)
  }
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_v_p1.shape[0];
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_p1.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 7, __pyx_L1_error)
  }
  ...
  __pyx_r = sqrt(((pow(((*((double *) ( /* dim=0 */ (__pyx_v_p1.data + __pyx_t_1 * __pyx_v_p1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_p2.data + __pyx_t_3 * __pyx_v_p2.strides[0]) )))), 2.0) + pow(((*((double *) ( /* dim=0 */ (__pyx_v_p1.data + __pyx_t_4 * __pyx_v_p1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_p2.data + __pyx_t_5 * __pyx_v_p2.strides[0]) )))), 2.0)) + pow(((*((double *) ( /* dim=0 */ (__pyx_v_p1.data + __pyx_t_6 * __pyx_v_p1.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_p2.data + __pyx_t_7 * __pyx_v_p2.strides[0]) )))), 2.0)));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("filter_cython_new.distance_cython", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_17filter_cython_new_1distance_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_17filter_cython_new_1distance_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("distance_cython (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_p2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("distance_cython", 1, 2, 2, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "distance_cython") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_p1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_p1.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_p2 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_p2.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("distance_cython", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("filter_cython_new.distance_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_17filter_cython_new_distance_cython(__pyx_self, __pyx_v_p1, __pyx_v_p2);
...
static PyObject *__pyx_pf_17filter_cython_new_distance_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_p1, __Pyx_memviewslice __pyx_v_p2) {
  ...
  if (unlikely(!__pyx_v_p1.memview)) { __Pyx_RaiseUnboundLocalError("p1"); __PYX_ERR(0, 6, __pyx_L1_error) }
  if (unlikely(!__pyx_v_p2.memview)) { __Pyx_RaiseUnboundLocalError("p2"); __PYX_ERR(0, 6, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_17filter_cython_new_distance_cython(__pyx_v_p1, __pyx_v_p2, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static PyObject *__pyx_pw_17filter_cython_new_3region_filter_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_17filter_cython_new_region_filter_cython(CYTHON_UNUSED __Pyx_memviewslice __pyx_v_center, __Pyx_memviewslice __pyx_v_pcd, int __pyx_v_hand_cloud, __Pyx_memviewslice __pyx_v_hand_center, __Pyx_memviewslice __pyx_v_obj_center, double __pyx_v_median_distance, CYTHON_UNUSED int __pyx_skip_dispatch) {
  float __pyx_v_dist;
  int __pyx_v_length;
  int __pyx_v_i;
  __Pyx_memviewslice __pyx_v_first_point = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_dist_temp;
  float __pyx_v_mean_distance;
  ...
  int __pyx_v_abort;
  int __pyx_v_temp;
  int __pyx_v_length_deleted;
  Py_ssize_t __pyx_v_length_2;
  PyObject *__pyx_v_new_cloud = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("region_filter_cython", 0);
  __PYX_INC_MEMVIEW(&__pyx_v_pcd, 1);

  /* "filter_cython_new.pyx":12
 * 
 *     #define dist dummy for calculation
 ...
 *     cdef int i
 */
  __pyx_v_dist = 50000.0;

  /* "filter_cython_new.pyx":13
 *     #define dist dummy for calculation
 *     cdef float dist = 50000
 *     cdef int length = pcd.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int i
 ...
 */
  __pyx_v_length = (__pyx_v_pcd.shape[0]);

  /* "filter_cython_new.pyx":18
 ...
 *                 dist = dist_temp
 */
      __pyx_t_5.data = __pyx_v_pcd.data;
      __pyx_t_5.memview = __pyx_v_pcd.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_pcd.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_pcd.strides[0];
        if (__pyx_tmp_idx < 0)
...
__pyx_t_5.shape[0] = __pyx_v_pcd.shape[1];
__pyx_t_5.strides[0] = __pyx_v_pcd.strides[1];
    __pyx_t_5.suboffsets[0] = -1;

__pyx_v_dist_temp = __pyx_f_17filter_cython_new_distance_cython(__pyx_t_5, __pyx_v_hand_center, 0);
      __PYX_XDEC_MEMVIEW(&__pyx_t_5, 1);
      __pyx_t_5.memview = NULL;
      __pyx_t_5.data = NULL;

      /* "filter_cython_new.pyx":22
 *         for i in range(length):
 *             dist_temp = distance_cython(pcd[i], hand_center)
 *             if dist_temp < dist:             # <<<<<<<<<<<<<<
 *                 dist = dist_temp
 *                 first_point = pcd[i]
 */
      __pyx_t_1 = ((__pyx_v_dist_temp < __pyx_v_dist) != 0);
      if (__pyx_t_1) {

        /* "filter_cython_new.pyx":23
 *             dist_temp = distance_cython(pcd[i], hand_center)
 *             if dist_temp < dist:
 *                 dist = dist_temp             # <<<<<<<<<<<<<<
 *                 first_point = pcd[i]
 *     else:
 */
        __pyx_v_dist = __pyx_v_dist_temp;

        /* "filter_cython_new.pyx":24
 *             if dist_temp < dist:
 *                 dist = dist_temp
 *                 first_point = pcd[i]             # <<<<<<<<<<<<<<
 *     else:
...
__PYX_XDEC_MEMVIEW(&__pyx_v_first_point, 1);
        __pyx_v_first_point = __pyx_t_5;
        __pyx_t_5.memview = NULL;
        __pyx_t_5.data = NULL;
...
__pyx_v_dist_temp = __pyx_f_17filter_cython_new_distance_cython(__pyx_t_5, __pyx_v_obj_center, 0);
      __PYX_XDEC_MEMVIEW(&__pyx_t_5, 1);
      __pyx_t_5.memview = NULL;
      __pyx_t_5.data = NULL;

      /* "filter_cython_new.pyx":29
 *             for i in range(length):
 *                 dist_temp = distance_cython(pcd[i], obj_center)
 *                 if dist_temp < dist:             # <<<<<<<<<<<<<<
 *                     dist = dist_temp
 ...
 */
  __pyx_v_mean_distance = 0.0;

  /* "filter_cython_new.pyx":36
 *     #calculate mean distance between points
 *     cdef float mean_distance = 0
 *     for i in range(length-1):             # <<<<<<<<<<<<<<
 *         mean_distance += distance_cython(pcd[i], pcd[i-1])
...
__pyx_t_8.data = __pyx_v_pcd.data;
    __pyx_t_8.memview = __pyx_v_pcd.memview;
...
__pyx_t_8.shape[0] = __pyx_v_pcd.shape[1];
__pyx_t_8.strides[0] = __pyx_v_pcd.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_v_mean_distance = (__pyx_v_mean_distance + __pyx_f_17filter_cython_new_distance_cython(__pyx_t_5, __pyx_t_8, 0));
    __PYX_XDEC_MEMVIEW(&__pyx_t_5, 1);
    __pyx_t_5.memview = NULL;
    __pyx_t_5.data = NULL;
 ...
 */
    ...
    __pyx_v_mean_distance = (__pyx_v_mean_distance / __pyx_v_i);
 ...
 */
  /*else*/ {
    ...
    __pyx_t_9 = (__pyx_t_10) ? __Pyx_PyObject_Call2Args(__pyx_t_11, __pyx_t_10, __pyx_tuple_) : __Pyx_PyObject_CallOneArg(__pyx_t_11, __pyx_tuple_);
    __Pyx_XDECREF(__pyx_t_10); __pyx_t_10 = 0;
    if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_9, PyBUF_WRITABLE); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 42, __pyx_L1_error)
 ...
 *     cdef int count = 1
 */
  __pyx_t_9 = __Pyx_PyDict_NewPresized(0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_v_dicti = ((PyObject*)__pyx_t_9);
  __pyx_t_9 = 0;
 ...
 *     indices = []
 */
  if (unlikely(!__pyx_v_first_point.memview)) { __Pyx_RaiseUnboundLocalError("first_point"); __PYX_ERR(0, 48, __pyx_L1_error) }
  __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_first_point, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  if (unlikely(PyDict_SetItem(__pyx_v_dicti, __pyx_int_0, __pyx_t_9) < 0)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 */
  while (1) {
    __pyx_t_1 = ((__pyx_v_abort < 30) != 0);
    if (!__pyx_t_1) break;

    /* "filter_cython_new.pyx":62
 * 
 *     while (abort < 30):
 *         indices = []             # <<<<<<<<<<<<<<
 *         temp = len(pcd)
 ...
 */
    __pyx_t_9 = PyList_New(0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF_SET(__pyx_v_indices, ((PyObject*)__pyx_t_9));
    __pyx_t_9 = 0;

    /* "filter_cython_new.pyx":63
 *     while (abort < 30):
 *         indices = []
 *         temp = len(pcd)             # <<<<<<<<<<<<<<
 *         length_deleted = pcd.shape[0]
 ...
 */
    __pyx_t_13 = __Pyx_MemoryView_Len(__pyx_v_pcd); 
    __pyx_v_temp = __pyx_t_13;

    /* "filter_cython_new.pyx":64
 *         indices = []
 *         temp = len(pcd)
 *         length_deleted = pcd.shape[0]             # <<<<<<<<<<<<<<
 *         for i in range(length_deleted):
 *             if test == -1:
 */
    __pyx_v_length_deleted = (__pyx_v_pcd.shape[0]);

    /* "filter_cython_new.pyx":65
 *         temp = len(pcd)
 *         length_deleted = pcd.shape[0]
 *         for i in range(length_deleted):             # <<<<<<<<<<<<<<
 *             if test == -1:
 ...
 */
    __pyx_t_2 = __pyx_v_length_deleted;
    __pyx_t_3 = __pyx_t_2;
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_i = __pyx_t_4;

      /* "filter_cython_new.pyx":66
 *         length_deleted = pcd.shape[0]
 *         for i in range(length_deleted):
 *             if test == -1:             # <<<<<<<<<<<<<<
 *                 if distance_cython(pcd[i], first_point) <= mean_distance:
 *                     dicti[count] = pcd[i]
 */
      __pyx_t_1 = ((__pyx_v_test == -1L) != 0);
      if (__pyx_t_1) {

        /* "filter_cython_new.pyx":67
 *         for i in range(length_deleted):
 *             if test == -1:
 *                 if distance_cython(pcd[i], first_point) <= mean_distance:             # <<<<<<<<<<<<<<
 *                     dicti[count] = pcd[i]
...
if (unlikely(!__pyx_v_first_point.memview)) { __Pyx_RaiseUnboundLocalError("first_point"); __PYX_ERR(0, 67, __pyx_L1_error) }
        __pyx_t_1 = ((__pyx_f_17filter_cython_new_distance_cython(__pyx_t_8, __pyx_v_first_point, 0) <= __pyx_v_mean_distance) != 0);
        __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
        __pyx_t_8.memview = NULL;
        __pyx_t_8.data = NULL;
        if (__pyx_t_1) {

          /* "filter_cython_new.pyx":68
 *             if test == -1:
 *                 if distance_cython(pcd[i], first_point) <= mean_distance:
 *                     dicti[count] = pcd[i]             # <<<<<<<<<<<<<<
 *                     indices.append(i)
...
__pyx_t_9 = __pyx_memoryview_fromslice(__pyx_t_8, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_9);
          __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
          __pyx_t_8.memview = NULL;
          __pyx_t_8.data = NULL;
          __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_count); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_11);
          if (unlikely(PyDict_SetItem(__pyx_v_dicti, __pyx_t_11, __pyx_t_9) < 0)) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;

          /* "filter_cython_new.pyx":69
 *                 if distance_cython(pcd[i], first_point) <= mean_distance:
 *                     dicti[count] = pcd[i]
 *                     indices.append(i)             # <<<<<<<<<<<<<<
 *                     count += 1
 * 
 */
          __pyx_t_9 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 69, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_9);
          __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_indices, __pyx_t_9); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 69, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;

          /* "filter_cython_new.pyx":70
 *                     dicti[count] = pcd[i]
 *                     indices.append(i)
 *                     count += 1             # <<<<<<<<<<<<<<
 * 
...
if (unlikely(!__pyx_v_next_point.memview)) { __Pyx_RaiseUnboundLocalError("next_point"); __PYX_ERR(0, 73, __pyx_L1_error) }
        __pyx_t_1 = ((__pyx_f_17filter_cython_new_distance_cython(__pyx_t_8, __pyx_v_next_point, 0) <= __pyx_v_mean_distance) != 0);
        __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
        __pyx_t_8.memview = NULL;
        __pyx_t_8.data = NULL;
        if (__pyx_t_1) {

          /* "filter_cython_new.pyx":74
 *             else:
 *                 if distance_cython(pcd[i], next_point) <= mean_distance:
 *                     dicti[count] = pcd[i]             # <<<<<<<<<<<<<<
 *                     indices.append(i)
...
__pyx_t_9 = __pyx_memoryview_fromslice(__pyx_t_8, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 74, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_9);
          __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
          __pyx_t_8.memview = NULL;
          __pyx_t_8.data = NULL;
          __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_count); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 74, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_11);
          if (unlikely(PyDict_SetItem(__pyx_v_dicti, __pyx_t_11, __pyx_t_9) < 0)) __PYX_ERR(0, 74, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;

          /* "filter_cython_new.pyx":75
 *                 if distance_cython(pcd[i], next_point) <= mean_distance:
 *                     dicti[count] = pcd[i]
 *                     indices.append(i)             # <<<<<<<<<<<<<<
 *                     count += 1
 *         test = 1
 */
          __pyx_t_9 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 75, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_9);
          __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_indices, __pyx_t_9); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 75, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;

          /* "filter_cython_new.pyx":76
 *                     dicti[count] = pcd[i]
 *                     indices.append(i)
 *                     count += 1             # <<<<<<<<<<<<<<
 *         test = 1
 ...
 *         if temp == len(pcd):
 */
    __Pyx_GetModuleGlobalName(__pyx_t_11, __pyx_n_s_random); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_11, __pyx_n_s_choice); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    __pyx_t_11 = __Pyx_PyDict_Values(__pyx_v_dicti); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __pyx_t_15 = PySequence_List(__pyx_t_11); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 78, __pyx_L1_error)
    ...
    __pyx_t_9 = (__pyx_t_11) ? __Pyx_PyObject_Call2Args(__pyx_t_10, __pyx_t_11, __pyx_t_15) : __Pyx_PyObject_CallOneArg(__pyx_t_10, __pyx_t_15);
    __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
    __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
    if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __pyx_t_16 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_9, PyBUF_WRITABLE); if (unlikely(!__pyx_t_16.memview)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __PYX_XDEC_MEMVIEW(&__pyx_v_next_point, 1);
    __pyx_v_next_point = __pyx_t_16;
    __pyx_t_16.memview = NULL;
    __pyx_t_16.data = NULL;

    /* "filter_cython_new.pyx":79
 *         test = 1
 *         next_point = random.choice(list(dicti.values()))
 *         pcd = np.delete(pcd, indices, axis = 0)             # <<<<<<<<<<<<<<
 *         if temp == len(pcd):
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_delete); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 79, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_pcd, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 79, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    ...
    PyTuple_SET_ITEM(__pyx_t_15, 1, __pyx_v_indices);
    __pyx_t_9 = 0;
    ...
    __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_10, __pyx_t_15, __pyx_t_9); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 79, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_11, PyBUF_WRITABLE); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 79, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    __PYX_XDEC_MEMVIEW(&__pyx_v_pcd, 1);
    __pyx_v_pcd = __pyx_t_12;
    __pyx_t_12.memview = NULL;
    __pyx_t_12.data = NULL;

    /* "filter_cython_new.pyx":80
 *         next_point = random.choice(list(dicti.values()))
 *         pcd = np.delete(pcd, indices, axis = 0)
 *         if temp == len(pcd):             # <<<<<<<<<<<<<<
 *             abort += 1
 ...
 */
    __pyx_t_13 = __Pyx_MemoryView_Len(__pyx_v_pcd); 
    __pyx_t_1 = ((__pyx_v_temp == __pyx_t_13) != 0);
    if (__pyx_t_1) {

      /* "filter_cython_new.pyx":81
 *         pcd = np.delete(pcd, indices, axis = 0)
 *         if temp == len(pcd):
 *             abort += 1             # <<<<<<<<<<<<<<
 *         if temp != len(pcd):
 ...
 * 
 */
  __pyx_t_17 = PyDict_Size(__pyx_v_dicti); if (unlikely(__pyx_t_17 == ((Py_ssize_t)-1))) __PYX_ERR(0, 85, __pyx_L1_error)
  __pyx_v_length_2 = __pyx_t_17;

  /* "filter_cython_new.pyx":86
 * 
 *     length_2 = len(dicti)
 *     new_cloud = np.zeros((length_2, 3))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_15 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_zeros); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_15);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = PyInt_FromSsize_t(__pyx_v_length_2); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  ...
  __pyx_t_11 = (__pyx_t_9) ? __Pyx_PyObject_Call2Args(__pyx_t_15, __pyx_t_9, __pyx_t_10) : __Pyx_PyObject_CallOneArg(__pyx_t_15, __pyx_t_10);
  __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
  __pyx_v_new_cloud = __pyx_t_11;
  __pyx_t_11 = 0;

  /* "filter_cython_new.pyx":89
 * 
 *     #cdef int index = 0
 ...
 * 
 */
  __pyx_t_11 = __Pyx_PyDict_Items(__pyx_v_dicti); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  if (likely(PyList_CheckExact(__pyx_t_11)) || PyTuple_CheckExact(__pyx_t_11)) {
    __pyx_t_15 = __pyx_t_11; __Pyx_INCREF(__pyx_t_15); __pyx_t_17 = 0;
    __pyx_t_18 = NULL;
  } else {
    __pyx_t_17 = -1; __pyx_t_15 = PyObject_GetIter(__pyx_t_11); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 89, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __pyx_t_18 = Py_TYPE(__pyx_t_15)->tp_iternext; if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 89, __pyx_L1_error)
  }
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  for (;;) {
    if (likely(!__pyx_t_18)) {
      if (likely(PyList_CheckExact(__pyx_t_15))) {
        ...
        __pyx_t_11 = PyList_GET_ITEM(__pyx_t_15, __pyx_t_17); __Pyx_INCREF(__pyx_t_11); __pyx_t_17++; if (unlikely(0 < 0)) __PYX_ERR(0, 89, __pyx_L1_error)
        #else
        __pyx_t_11 = PySequence_ITEM(__pyx_t_15, __pyx_t_17); __pyx_t_17++; if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        #endif
      } else {
        if (__pyx_t_17 >= PyTuple_GET_SIZE(__pyx_t_15)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_11 = PyTuple_GET_ITEM(__pyx_t_15, __pyx_t_17); __Pyx_INCREF(__pyx_t_11); __pyx_t_17++; if (unlikely(0 < 0)) __PYX_ERR(0, 89, __pyx_L1_error)
        #else
        __pyx_t_11 = PySequence_ITEM(__pyx_t_15, __pyx_t_17); __pyx_t_17++; if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        #endif
      ...
      __pyx_t_11 = __pyx_t_18(__pyx_t_15);
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_11))) || (PyList_CheckExact(__pyx_t_11))) {
      ...
      Py_ssize_t index = -1;
      __pyx_t_19 = PyObject_GetIter(__pyx_t_11); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 89, __pyx_L1_error)
      ...
      __Pyx_GOTREF(__pyx_t_10);
      index = 1; __pyx_t_9 = __pyx_t_20(__pyx_t_19); if (unlikely(!__pyx_t_9)) goto __pyx_L25_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_9);
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_20(__pyx_t_19), 2) < 0) __PYX_ERR(0, 89, __pyx_L1_error)
      __pyx_t_20 = NULL;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_array); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = NULL;
    if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_10))) {
    ...
    __pyx_t_11 = (__pyx_t_9) ? __Pyx_PyObject_Call2Args(__pyx_t_10, __pyx_t_9, __pyx_v_value) : __Pyx_PyObject_CallOneArg(__pyx_t_10, __pyx_v_value);
    __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
    if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    if (unlikely(PyObject_SetItem(__pyx_v_new_cloud, __pyx_v_key, __pyx_t_11) < 0)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
 ...
 */
  ...
  /* "filter_cython_new.pyx":93
 * 
 * 
 *     return new_cloud             # <<<<<<<<<<<<<<
 */
  __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_v_new_cloud, PyBUF_WRITABLE); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 93, __pyx_L1_error)
  __pyx_r = __pyx_t_12;
  __pyx_t_12.memview = NULL;
  __pyx_t_12.data = NULL;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("filter_cython_new.region_filter_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __Pyx_XDECREF(__pyx_v_new_cloud);
...
/* Python wrapper */
static PyObject *__pyx_pw_17filter_cython_new_3region_filter_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_17filter_cython_new_3region_filter_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_center = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_pcd = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_hand_cloud;
  __Pyx_memviewslice __pyx_v_hand_center = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_obj_center = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_median_distance;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("region_filter_cython (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_center,&__pyx_n_s_pcd,&__pyx_n_s_hand_cloud,&__pyx_n_s_hand_center,&__pyx_n_s_obj_center,&__pyx_n_s_median_distance,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pcd)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("region_filter_cython", 1, 6, 6, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_hand_cloud)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("region_filter_cython", 1, 6, 6, 2); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_hand_center)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("region_filter_cython", 1, 6, 6, 3); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_obj_center)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("region_filter_cython", 1, 6, 6, 4); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_median_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("region_filter_cython", 1, 6, 6, 5); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "region_filter_cython") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_center = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_center.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_pcd = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_pcd.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_hand_cloud = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_hand_cloud == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_hand_center = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_hand_center.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_obj_center = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_obj_center.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_median_distance = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_median_distance == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("region_filter_cython", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("filter_cython_new.region_filter_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_17filter_cython_new_2region_filter_cython(__pyx_self, __pyx_v_center, __pyx_v_pcd, __pyx_v_hand_cloud, __pyx_v_hand_center, __pyx_v_obj_center, __pyx_v_median_distance);
...
static PyObject *__pyx_pf_17filter_cython_new_2region_filter_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_center, __Pyx_memviewslice __pyx_v_pcd, int __pyx_v_hand_cloud, __Pyx_memviewslice __pyx_v_hand_center, __Pyx_memviewslice __pyx_v_obj_center, double __pyx_v_median_distance) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("region_filter_cython", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_center.memview)) { __Pyx_RaiseUnboundLocalError("center"); __PYX_ERR(0, 9, __pyx_L1_error) }
  if (unlikely(!__pyx_v_pcd.memview)) { __Pyx_RaiseUnboundLocalError("pcd"); __PYX_ERR(0, 9, __pyx_L1_error) }
  if (unlikely(!__pyx_v_hand_center.memview)) { __Pyx_RaiseUnboundLocalError("hand_center"); __PYX_ERR(0, 9, __pyx_L1_error) }
  if (unlikely(!__pyx_v_obj_center.memview)) { __Pyx_RaiseUnboundLocalError("obj_center"); __PYX_ERR(0, 9, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_17filter_cython_new_region_filter_cython(__pyx_v_center, __pyx_v_pcd, __pyx_v_hand_cloud, __pyx_v_hand_center, __pyx_v_obj_center, __pyx_v_median_distance, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 9, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_pcd, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_hand_center, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_obj_center, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "filter_cython_new.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "filter_cython_new.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "filter_cython_new.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "filter_cython_new._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"distance_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_17filter_cython_new_1distance_cython, METH_VARARGS|METH_KEYWORDS, 0},
  {"region_filter_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_17filter_cython_new_3region_filter_cython, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_filter_cython_new(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_filter_cython_new},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_hand_center, __pyx_k_hand_center, sizeof(__pyx_k_hand_center), 0, 0, 1, 1},
  {&__pyx_n_s_hand_cloud, __pyx_k_hand_cloud, sizeof(__pyx_k_hand_cloud), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_median_distance, __pyx_k_median_distance, sizeof(__pyx_k_median_distance), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_obj_center, __pyx_k_obj_center, sizeof(__pyx_k_obj_center), 0, 0, 1, 1},
 ...
 *     cdef double[:] next_point
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_int_1, __pyx_int_3); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 42, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfilter_cython_new(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfilter_cython_new(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_filter_cython_new(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_filter_cython_new(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_filter_cython_new(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'filter_cython_new' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_filter_cython_new(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("filter_cython_new", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_filter_cython_new) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "filter_cython_new")) {
      if (unlikely(PyDict_SetItemString(modules, "filter_cython_new", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init filter_cython_new", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init filter_cython_new");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
